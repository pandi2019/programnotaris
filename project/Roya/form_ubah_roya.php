...
include"../koneksi.php";
$id=$_GET['id_nasabah'];
$sql=mysqli_query($koneksi,"SELECT * FROM data_roya WHERE id_nasabah='$id'");
...
<html>
	...
	<body>
	  <div class=tengah>
	  <form action="ubah_roya.php" method="post">	 
		<center>
		<table border=0 height=550>
			<tr><td colspan=2 align=center><u><font size="6" color="white">DATA NASABAH ROYA</font></u></td></tr>
			<tr>
